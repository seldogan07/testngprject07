...
import static com.myapp.utilities.JSUtils.*;
import static com.myapp.utilities.ReusableMethods.*;
...
public class TC_001_SuccessfulShippingAddressAddition {
    ...
    String zipCode;
    @Test(priority = 2)
    public void TC_001_Test() throws Exception {
        homePage = new PearlyMarketHomePage();
        ...
        /*
        WebElement dropdownCounty = waitForVisibility(shippingAddressesPage.shippingSelectCounty,15);
        clickWithTimeoutByJS(dropdownCounty);
        Select optionCounty = new Select(dropdownCounty);
        optionCounty.selectByIndex(1);
         */
        ...
        waitForVisibility(shippingAddressesPage.shippingSaveAddressButton,5).click();
        ...
        assertEquals(streetAddress,Driver.getDriver().findElement(By.xpath("(//td)[5]")).getText());
