...
//    9_Verify that an error message is displayed, indicating that the verification code is required.
     @Test
    public void US09_TC04 () throws IOException {
        ...
        pearlyMarketVendorRegisterPage.emailBox.sendKeys(ConfigReader.getProperty("vendorregistermail_forinvalidverification"));
        ...
        // 9_Verify that an error message is displayed, indicating that the verification code is required.
        ReusableMethods.verifyElementDisplayed(pearlyMarketVendorRegisterPage.verifCodeRequired);
