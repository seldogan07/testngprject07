...
//7_Verify that “Verification code sent to your email: arbenkeilai@outlook.com.” is visible
//8_ Proceed with the registration process
//9_Verify that an error message is displayed, indicating that the password must contain at least one special character.
...
//      Wait until the verification code will be sent from pearly market
    ...
    // We can directly registered with no special char password.
