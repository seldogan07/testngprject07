...
//7_ Enter a password that contains uppercase letters, lowercase letters, and special characters, but no digit
//8_ Proceed with the registration process
//9_Verify that an error message is displayed, indicating that the password must contain at least one digit.
    ...
    public void US09_TC08 () throws IOException {
        ...
        //5_Enter a valid email
        pearlyMarketVendorRegisterPage.emailBox.sendKeys(ConfigReader.getProperty("vendorregistermail_fornotdigit"));
        ...
        WaitUtils.waitFor(3);
        Driver.getDriver().findElement(By.id("i0116")).sendKeys("orhankao@outlook.com");
...
//      Wait until the verification code will be sent from pearly market
        ...
        // We can directly registered with no digit password.
