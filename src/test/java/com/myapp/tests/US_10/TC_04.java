...
//5_Verify that a password level chart is displayed under confirm password field
//6_Enter a password that meets the requirements for a strong password level (e.g., a mix of uppercase letters, lowercase letters, digits, and special characters).
//7_Verify that the password level chart indicates the password as "strong"
    ...
    public void US10_TC03 () throws IOException {
        ...
        //7_Verify that the password level chart indicates the password as "strong"
        pearlyMarketVendorRegisterPage.strongText.isDisplayed();
