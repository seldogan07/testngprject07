...
//7_Enter a password that meets the requirements for a strong password level (e.g., a mix of uppercase letters, lowercase letters, digits, and special characters).
//            8_Verify that the password level chart indicates the password as "strong"
